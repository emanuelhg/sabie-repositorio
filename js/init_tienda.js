$(document).ready(function() {
    ...
    $.getJSON("./json/productos.json", function (data) {
        ...
        $.each(productos, function (index, elemento) {
            ...
            items = `
                <div class="col col-md-4 d-flex justify-content-center contenedorCard cat-${ tipo }">
                    <div class="card border-primary" style="width: 18rem;">
                        <div class="imagenProducto">
                            <img src="./media/producto${ id }.png" class="card-img-top" alt="...">
                        ...
                        <div class="card-footer d-grid gap-2">
                            ...
                            <div style="font-size: 1rem;color: orangered;">
                                Cantidad:  
                                <input type="number" class="cantidadProdStyle rounded cantidadProd${ id }" id="quantity" name="quantity" value="1" min="1" max="10" onkeyup=refuerzaMinyMaX(this)>
                            </div>
